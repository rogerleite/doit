...
public class PackFinderTest {
	...
	public void shouldFindOnePack() {
		final PackFinder pf = new PackFinder();
		final List<FolderPack> packs = pf.lookForPacks(getRootPath() + "testPackFinder");
	...
	public void shouldInstantiateOnePack() {
		final PackFinder pf = new PackFinder();
		final List<FolderPack> packs = pf.lookForPacks(getRootPath() + "testPackFinder");
		final List<ExpressionPack> exprPacks = pf.instantiatePacks(packs);
