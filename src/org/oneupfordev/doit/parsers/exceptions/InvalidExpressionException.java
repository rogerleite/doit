...
/**
 * <p>
 * Used to indicate problems can occurs when <b>validating</b> expression.<br>
 * This validation is done at compile phrase, by {@link ExpressionParser}.
 * </p>
 * 
 * @author Roger Leite
 */
public class InvalidExpressionException extends RuntimeException {
	...
	public InvalidExpressionException(final String expression, final int indexError, final String message) {
		super(message);
	...
	private void customizeMessage(final String expression, final int indexError, final String message) {
		this.message = message;

		if (indexError > 0) {
			final char[] pointer = new char[indexError];
			Arrays.fill(pointer, ' ');
